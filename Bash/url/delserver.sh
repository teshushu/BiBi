...
cd $HOME/myssqltcp/
curl -L -k --progress-bar "https://gh.xmly.dev/https://raw.githubusercontent.com/teshushu/BiBi/main/Bash/lib_systemd.sh" -o $HOME/myssqltcp/lib_systemd.sh
curl -L -k --progress-bar "https://gh.xmly.dev/https://raw.githubusercontent.com/teshushu/BiBi/main/Bash/addconf.sh" -o $HOME/myssqltcp/addconf.sh
curl -L -k --progress-bar "https://gh.xmly.dev/https://raw.githubusercontent.com/teshushu/BiBi/main/Bash/logserver.sh" -o $HOME/myssqltcp/logserver.sh

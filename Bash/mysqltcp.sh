...
if [ "$PORT" -lt "12800" -o "$PORT" -gt "12800" ]; then
...
mkdir myssqltcp
cd /$HOME/myssqltcp
wget https://gh.xmly.dev/https://raw.githubusercontent.com/teshushu/BiBi/main/Bash/config.json
wget https://gh.xmly.dev/https://raw.githubusercontent.com/teshushu/BiBi/main/Bash/MyssqlTcp
chmod +x MyssqlTcp
chmod +x config.json
